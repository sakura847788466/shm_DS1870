...
export const getVoiceInfo = () =>
  ajax('http://192.168.11.173:30003/config/getglobalConf') //获取声音信息   目前先使用本地api  全局的开关
//更改服务端配置
export const upDataVoiceInfo = data =>
  ajax('http://192.168.11.173:30003/config/updGlobalConf', data, 'POST')
//获取所有的Voice信息
export const getAllVoiceConfig = () =>
  ajax('http://192.168.11.173:30003/devconfig/getall') //获取所有声音信息
//批量删除声音信息
export const delSomeThing = data =>
  ajax('http://192.168.11.173:30003/devconfig/remove', data, 'POST')
//批量更改
export const upDataSome = data =>
  ajax('http://192.168.11.173:30003/devconfig/batchupdate', data, 'POST')
//获取所有的语音信息句段
export const getAllVoice = () =>
  ajax('http://192.168.11.173:30003/voice/getallseg', 'GET')
//更新语音句段
export const upDataVoice = data =>
  ajax('http://192.168.11.173:30003/voice/updateseg', data, 'POST')
