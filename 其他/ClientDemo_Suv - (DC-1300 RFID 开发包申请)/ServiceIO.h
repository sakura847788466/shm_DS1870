...
extern "C"
{
	...
	*/
	...
	DWORD __stdcall DAS_RFIDTag_ClrCache();
	DWORD __stdcall DAS_RFIDTag_Search(unsigned int *numOfTag);
	DWORD __stdcall DAS_RFIDTag_Read_EPCID(byte *buffer, int buflen);
	DWORD __stdcall DAS_RFIDTag_Write_EPCID(byte *buffer, int buflen);
	DWORD __stdcall DAS_RFIDTag_FetchReadPower(USHORT *powrval);
	DWORD __stdcall DAS_RFIDTag_FetchWritePower(USHORT *powrval);
	DWORD __stdcall DAS_RFIDTag_SetReadPower(USHORT powerval);
	DWORD __stdcall DAS_RFIDTag_SetWritePower(USHORT powerval);
	DWORD __stdcall DAS_RFIDTag_CommFast();
#ifdef __cplusplus
}
#endif
#endif